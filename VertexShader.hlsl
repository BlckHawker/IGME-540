...
{
    matrix worldMatrix, projectionMatrix, viewMatrix, worldInvTranspose, shadowView, shadowProjection;
}
...
VertexToPixel main( VertexShaderInput input )
{
    ...
    matrix shadowWVP = mul(shadowProjection, mul(shadowView, worldMatrix));
